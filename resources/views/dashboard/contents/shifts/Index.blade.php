...
<div id="app-panel-tickets">
    <!-- Datos del turno -->
    <div class="row" v-if="panel.isActive">
        <!-- Panel izquierdo -->
        <div class="col-md-4">
            <button class="btn btn-block btn-lg mb-2" :class="userStatus.btnType" type="button" v-on:click="userBreak(2)" v-bind:disabled="disabledButtons.buttonConnect">
            ...
            <div class="tile p-0 mb-0" style="height: 380px; overflow-y: scroll;">
                ...
                <div class="tile-body">
                    <div class="row text-center my-3">
                        <div class="col-8"><h5>Especialidad</h5></div>
                        <div class="col-4 text-truncate"><h5>Total</h5></div>								
                    </div>

                    <shifts-speciality v-for="speciality in panel.userSpecialities"
                        v-bind:key = "speciality.speciality_type_id"
                        :id = "speciality.speciality_type_id"
