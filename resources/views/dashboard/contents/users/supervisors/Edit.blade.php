...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12 col-md-8 col-lg-6">
            {!! Form::open(['route' => 'user-supervisor-update', 'method' => 'PUT']) !!}
