@section('title', 'Cajas')
@section('subtitle', 'Listado de Cajas')
@section('icon', 'fa fa-cash-register')
@section('breadcrumb')
    <li class="breadcrumb-item active"><a href="#">Cajas</a></li>
@endsection
                ...
                <div class="tile-title">
                    <div class="row">
                        <div class="col-md-12 text-right">
                            <a href="/dashboard/boxes/create" class="btn btn-primary" role="button">Nueva caja</a>
                        </div>
                    </div>
                </div>
                <div class="tile-body">
                                            ...
                                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                                ...
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="/dashboard/boxes/edit/{{ $item->id }}">Editar</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
